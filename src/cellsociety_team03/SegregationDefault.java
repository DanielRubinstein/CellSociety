...
import java.util.HashMap;
	...
	public class SegregationDefault extends Default{
	    // name in data file that will indicate it represents data for this type of object
		 private static final String DATA_TYPE = "Segregation";
	    ...
	    private List<String> ALLOWED_STATES =  Arrays.asList(new String[] {
		        "red",
		        "blue",
		        "empty"
	    });
	    ...
	    private Map<String,Color>COLOR_CHOCIE=getColors();
	    ...
	    private Map<String,Integer>MAXIMUMS=getMax();
